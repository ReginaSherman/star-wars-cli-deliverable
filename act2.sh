...
$ touch obi_wan.txt luke.skywalker.txt
...
$ mv {luke.skywalker.txt,obi_wan.txt,princess_leia.txt} millenium_falcon
# 7. Move the millenium_falcon into the death_star.
~/Desktop/seir-1213/unit1/homework/Star_Wars_CLI_Deliverable/star_wars - master
